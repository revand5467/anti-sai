          ...
          <CountBox title="Total Backers" value={donators.length} />
            ...
            <div className="mt-[60px]  flex lg:flex-row flex-col gap-5">
                <div className="flex-[2] flex flex-col gap-[40px]">
                    ...
                    <div className='flex items-center gap-3 font-epilogue font-semibold text-[18px] text-black uppercase my-10'>
                        <div class="flex flex-row space-x-1">
                            <div onClick={handleupVoteCall}
                                class="bg-green-500 shadow-lg shadow-   text-black cursor-pointer px-3 py-1 text-center justify-center items-center rounded-xl flex space-x-2 flex-row">
                                ...
                                <span>Handover to police </span>
                            </div>
                            <div onClick={handleReject}
                                class="bg-red-500 shadow-lg shadow-  text-black cursor-pointer px-3 text-center justify-center items-center py-1 rounded-xl flex space-x-2 flex-row">
